module.exports = function(app) {
    ...
    app.Design.designJsInit = function() {
        app.Design.materializeJsInit();
        app.Design.sketchNameSizeEffect();
        app.Design.sketchNameSet();
    };
     ...
     */
    app.Design.materializeJsInit = function() {
        // Navigation bar
        ...
        M.Tabs.init(document.getElementById("tab_wrapper"), {
            swipeable: false,
            onShow: app.changeTabs
        });
    ...
    app.Design.bindDesignEventListeners = function() {
        // Resize blockly workspace on window resize
        window.addEventListener(
            'resize', app.Design.resizeBlocklyWorkspace, false);
    };
     ...
     */
    app.Design.buttonLoadXmlCodeDisplay = function() {
     ...
     */
    app.Design.largeIdeButtonSpinner = function(active) {
     ...
     */
    app.Design.displayToolbox = function(show) {
    ...
    var resizeTwice = false;
    app.Design.resizeBlocklyWorkspace = function() {
        var contentBlocks = document.getElementById('content_blocks');
        var wrapperPanelSize =
            app.Design.getBBox_(document.getElementById('blocks_panel'));
     ...
     */
    app.Design.materialAlert = function(title, body, confirm, callback) {
     ...
     */
    app.Design.openAdditionalBlocksModal = function(htmlContent) {
     ...
     */
    app.Design.createExtraBlocksCatHtml = function(title, description, clickBind) {
     ...
     */
    app.Design.MaterialToast = function(message) {
     ...
     */
    app.Design.arduinoIdeOutput = function(bodyEl) {
        ...
        app.Design.highlightIdeOutputHeader();
    };
     ...
     * @param {!element} bodyEl HTML to include into IDE output content area.
     */
    app.Design.resetIdeOutputContent = function(bodyEl) {
        var ideOuputContent = document.getElementById('content_ide_output');
        ideOuputContent.innerHTML = '<span class="arduino_dialog_out">' +
            app.Design.getLocalStr('arduinoOpWaiting') + '</span>';
    };
     ...
     */
    app.Design.sketchNameSizeEffect = function() {
     ...
     */
    app.Design.sketchNameSet = function(newName) {
    ...
    app.Design.highlightIdeOutputHeader = function() {
     ...
     */
    app.Design.contentHeightToggle = function() {
        ...
        PluginManager.contentHeightToggle();
    };
     ...
     * @private
     */
    app.Design.getBBox_ = function(element) {
